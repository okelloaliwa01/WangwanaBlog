...
class ArticleListView(ListView):
    # template_nameThe attribute is used to specify which template to use for rendering
    template_name = 'blog/article_index.html'

    # context_object_nameAttributes are used to name context variables(Use the name in the template)
...
class AuthorDetailView(ArticleListView):
    ...
    Author details page
    '''
    page_type = 'AuthorArticle Archive'
...
def page_not_found_view(
    ...
    return render(request,
                  template_name,
                  {'message': 'Damn，The address you visit ' + url + ' Is an unknown place. Please click on the homepage to see something else!',
                   'statuscode': '404'},
                  status=404)
...
def server_error_view(request, template_name='blog/error_page.html'):
    return render(request,
                  template_name,
                  {'message':
'Oops, something went wrong, I have collected the wrong information, and I will hurry to repair it later, please click on the homepage to see something else!',
                   'statuscode': '500'},
                  status=500)
...
def permission_denied_view(
    ...
    return render(
        request, template_name, {
            'message': 'Oops, you do not have permission to access this page, please click on the homepage to see something else!', 'statuscode': '403'}, status=403)
