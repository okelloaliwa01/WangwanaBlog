    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_keywords', models.TextField(default='', max_length=1000, verbose_name='Website keywords')),
                ('article_sub_length', models.IntegerField(default=300, verbose_name='Article summary length')),
                ('sidebar_article_count', models.IntegerField(default=10, verbose_name='Number of articles in the sidebar')),
                ('sidebar_comment_count', models.IntegerField(default=5, verbose_name='Number of comments in the sidebar')),
                ('show_google_adsense', models.BooleanField(default=False, verbose_name='Whether to show Google ads')),
                ...
                ('beiancode', models.CharField(blank=True, default='', max_length=2000, null=True, verbose_name='case number')),
                ('analyticscode', models.TextField(blank=True, default='', max_length=1000, null=True, verbose_name='Website statistics code')),
                ...
                ('resource_path', models.CharField(default='/var/www/resource/', max_length=300, verbose_name='Static file storage address')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_type', models.CharField(choices=[('i', 'Home'), ('l', 'List'), ('p', 'Article page'), ('a', 'Full Site'), ('s', 'Friendly link page')], default='i', max_length=1, verbose_name='Display type')),
                ('created_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Creation time')),
                ('last_mod_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='When modified')),
            ],
            options={
                'verbose_name': 'Links',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Creation time')),
                ('last_mod_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Last Modified')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Creation time')),
                ('last_mod_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Modificatio Time')),
                ('name', models.CharField(max_length=30, unique=True, verbose_name='Label name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('d', 'draft'), ('p', 'Publish')], default='p', max_length=1, verbose_name='Article status')),
                ...
                ('article_order', models.IntegerField(default=0, verbose_name='Sort, the higher the number, the higher')),
