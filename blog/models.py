...
class Article(BaseModel):
    ...
    comment_status = models.CharField(
        ...
        default='o')
    type = models.CharField('Document Type', max_length=1, choices=TYPE, default='a')
    ...
    article_order = models.IntegerField(
        'Sort, the higher the number, the higher', blank=False, null=False, default=0)
...
class Links(models.Model):
    ...
    created_time = models.DateTimeField('Creation time', default=now)
    last_mod_time = models.DateTimeField('When modified', default=now)
...
class BlogSettings(models.Model):
    ...
    sidebar_article_count = models.IntegerField("Number of articles in the sidebar", default=10)
    sidebar_comment_count = models.IntegerField("Number of comments in the sidebar", default=5)
