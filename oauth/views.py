...
def emailconfirm(request, id, sign):
    ...
    send_email(emailto=[oauthuser.email, ], title='Congratulations on your successful linking!', content=content)
...
class RequireEmailView(FormView):
    ...
    def form_valid(self, form):
        ...
        content = """
                ...
                {url}
                """.format(url=url)
        send_email(emailto=[email, ], title='Link your email', content=content)
        url = reverse('oauth:bindsuccess', kwargs={
            'oauthid': oauthid
        })
        url = url + '?type=email'
...
def bindsuccess(request, oauthid):
    ...
    if type == 'email':
        ...
        content = "Congratulations, the linkiing is successful within one step. Please log in to your mailbox to view the email to complete the binding, thank you."
    else:
        title = 'link successfully'
        content = "Congratulations on your successful linkinging. In the future, you can use {type} to directly log in to this site without a password. Thank you for your attention to this site. ".format(
            type=oauthuser.type)
