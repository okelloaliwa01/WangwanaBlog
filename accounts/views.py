...
def account_result(request):
    ...
    if type and type in ['register', 'validation']:
        if type == 'register':
            content = '''
    Congratulations on your successful registration. A verification email has been sent to your {email} mailbox. Please verify your mailbox and log in to this site.
